...
#ifndef _savedhi_ALGORITHM_V1_H
#define _savedhi_ALGORITHM_V1_H

#include "savedhi-algorithm_v0.h"

const char *savedhi_type_template_v1(
        savedhiResultType type, uint16_t templateIndex);
const char savedhi_class_character_v1(
